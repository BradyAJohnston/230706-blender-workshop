...
Molecular nodes should be fully installed. See the [Getting Started](bradyajohnston.github.io/molecularNodes/getting-started.html) page on how to start importing into Blender!